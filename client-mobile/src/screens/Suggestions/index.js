...
const Suggestions = ( {suggestions} ) => {
    ...
    const fakeSuggest = [
        ...
        {title: 'Good News', id:'2', content:'Baisse des émissions Co2 en 2020'},
        ...
        <SafeAreaView style = {styles.screen}>
            ...
            <View style = {styles.listContainer}>
                <FlatList
                    data = { fakeSuggest }
                    renderItem = { (item) => 
                        <SuggestionCard title={item.item.title} content={item.item.content}/>
                    }
                />
            </View>
            <BackgroundCurve firstColor='white' secondColor={colors.lightGreen} />
            <Modal
                animationType="slide"
                transparent={true}
